...
\begin{innerlist}
        \item[] \textit{Revise \& Resubmit at \textbf{Journal of Political Economy}} \item[]\begin{footnotesize}
                Presentations: \textit{Carnegie Mellon*, Iowa*, Washington*, Federal Reserve Board*, ASU*, MFA 2020*, 7th SAFE Asset Pricing Workshop*, Alabama*}
        \end{footnotesize}
...
\begin{innerlist}
        ...
        \item[] \begin{footnotesize}
                Presentations: \textit{NBER Big Data and HPC in Economics*, ASU*, Microstructure Exchange*, Purdue*, Virginia*, SMU*, EFA 2020, World Symposium on Investment Research 2020, FMA 2020, NBER Big Data and Securities Markets*, EFA (US) 2021, SWFA 2021, CFMR 2021}
        \end{footnotesize}
...
\textbf{Instructor}
\begin{innerlist}
        \item[] FIN3144 Investments (UGRD), VT \hfill Fall 2021
        \item[] FIN5974 Doctoral Development (PhD), VT \hfill Fall 2021
...
\textbf{Committees}
\begin{innerlist}
        \item[] VT Ph.D. Program Committee \hfill 2021-2022
...
\textbf{Referee}
\begin{innerlist}
        \item[] Journal of Banking and Finance, Emerging Markets Review, Annals of Finance
\end{innerlist}
