...
\begin{innerlist}
        ...
        \end{footnotesize}
        \item[] We decompose the equity premium in the return dimension and find that the moderate left tail is the region that contributes the bulk of the risk premium.
\end{innerlist} 
