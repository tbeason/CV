...
\begin{innerlist}
        ...
        \end{footnotesize}
        \item[] I propose a method to model cash flows in macrofinance asset pricing models in a manner that respects equilibrium market clearing and matches the timing and nature of cash flow risk.
\end{innerlist}
